const ResidentialHouse = require('../../models/residential.house.model'); // Assuming ResidentialHouse model exists
...
const createResidentialHouse = async (houseData) => {
  ...
  residentialHouse.houseType = houseData.houseType;
...
const updateResidentialHouse = async (houseId, updateData) => {
  ...
  const allowedUpdates = [
    ...
    'houseType', 'ownership', 'flooring', 'transactionType', 'overlooking', 'facing',
