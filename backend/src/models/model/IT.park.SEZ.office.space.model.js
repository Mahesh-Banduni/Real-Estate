...
const officeITParkSEZSchema = new mongoose.Schema({
    //Property Location
...
const OfficeITParkSEZ = mongoose.model("OfficeITParkSEZ", officeITParkSEZSchema);
module.exports = OfficeITParkSEZ;
