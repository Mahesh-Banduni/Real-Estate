...
const industrialBuildingSchema = new mongoose.Schema({
    //Property Location
...
const IndustrialBuilding = mongoose.model("IndustrialBuilding", industrialBuildingSchema);
module.exports = IndustrialBuilding;