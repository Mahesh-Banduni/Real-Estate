...
const warehouseGodownSchema = new mongoose.Schema({
    //Property Location
...
const WarehouseGodown = mongoose.model("WarehouseGodown", warehouseGodownSchema);
module.exports = WarehouseGodown;
