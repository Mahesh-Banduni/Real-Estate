...
const residentialVillaController = require('../../controllers/Residential/residential.villa.controller');
 ...
 */
router.post('/', residentialVillaController.createResidentialVilla);
 ...
 */
router.get('/', residentialVillaController.getAllResidentialVillas);
 ...
 */
router.get('/:id', residentialVillaController.getResidentialVillaById);
 ...
 *         description: Villa not found
 */
router.put('/:id', residentialVillaController.updateResidentialVilla);
 ...
 *         description: Villa not found
 */
router.delete('/:id', residentialVillaController.deleteResidentialVilla);
