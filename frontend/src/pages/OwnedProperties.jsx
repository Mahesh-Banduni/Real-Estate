      ...
      {message ? (
        ...
        <div className="w-11/12 mx-auto">
          {/* <div className="my-10">
            ...
            <div className="flex gap-5 items-center justify-start w-full max-md:flex-col max-md:items-start">
              <div className="relative w-[20rem] max-[350px]:w-[12rem] ">
                <Input
                  value={ownedProperty}
                  name="city"
              ...
              <select
                ...
                name="propertyType"
                className="max-md:w-[20rem] max-[350px]:w-[12rem] rounded-none w-fit text-[#4B4B4B] border border-primary-color py-2 px-1 outline-none active:border-none hover:outline-none max-sm:text-sm"
              >
              ...
              <select
                ...
                onChange={handleDropdownChange}
                name="priceRange"
                className="max-md:w-[20rem] max-[350px]:w-[12rem] rounded-none w-fit text-[#4B4B4B] border border-primary-color py-2 px-1 outline-none hover:outline-none max-sm:text-sm"
              >
