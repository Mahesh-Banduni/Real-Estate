...
const AnimatedButton = React.memo(({ className, text }) => {
  return (
    <div
      className={`${className} cursor-pointer px-[0.6rem] max-[350px]:px-[0.4rem] py-[2px] uppercase relative w-fit overflow-hidden text-xs text-white flex items-center justify-center`}
    >
