...
const ContactInfo = () => {
  return (
    <div className="bg-[#F5F5F5] py-10 ">
      <div className="w-11/12 m-auto grid grid-rows-1 grid-cols-2 max-md:grid-rows-2 max-md:grid-cols-1 ">
        <div className="flex justify-center gap-5 flex-col max-md:items-center">
