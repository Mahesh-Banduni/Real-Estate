...
const studioApartmentSchema = new mongoose.Schema({
...
const StudioApartment = mongoose.model("StudioApartment", studioApartmentSchema);
module.exports = StudioApartment;